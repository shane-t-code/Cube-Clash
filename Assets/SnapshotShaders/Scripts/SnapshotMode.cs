...
public class SnapshotMode : MonoBehaviour
{
    ...
    private void Awake()
    {
       ...
       // if (useCanvas)
        ...
        //Material material = new Material (neonShader);
        //material.color = Color.cyan;
        //Material material2 = new Material(bloomShader);
    ...
    private void Start()
    {
        neonFilter = new NeonFilter("Neon", Color.cyan, bloomShader,
              new BaseFilter("", Color.white, neonShader));

        //snapshotCanvas.SetFilterProperties(neonFilter);
    }
    ...
    private void Update()
    {
        ...
        //snapshotCanvas.SetFilterProperties(new NeonFilter("Neon", Color.cyan, bloomShader,
        //    new BaseFilter("", Color.white, neonShader)));
    ...
    {
        neonFilter.OnRenderImage(src, dst);
    }
}
